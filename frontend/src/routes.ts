...
export const routeTable: RouteEntry[] = [
  ...
  { key: 'ORDER_STATUS', path: ROUTES.ORDER_STATUS, page: 'OrderStatusPage', importPath: './pages/OrderStatusPage', label: 'Order Status', admin: false, nav: true },
  ...
  { key: 'ADMIN_EVENTS', path: ROUTES.ADMIN_EVENTS, page: 'AdminEventsPage', importPath: './pages/admin/AdminEventsPage', label: 'Events', admin: true, nav: true },
